...
<div class="relative h-screen">
    <div class="absolute inset-0 flex items-center justify-center">
        <div class="w-[50%] h-[70%] mx-[25%] dark:border-white border-black my-5 border-x-4 rounded overflow-y-auto">
            <div class="relative">
                <form id="myForm" class="bg-transparent p-6 absolute left-[50%] translate-x-[-50%]" method="post" action="prep.php">
...
<div class="hidden bg-[#ef4444] w-fit rounded m-2 p-2 w-full mt-3 border-[#ef4444] bg-[#71717a] hover:cursor-not-allowed"></div>
</body>
</html>
